...
menu db "                              ",13,10,"           MENU            ",13,10," ",13,10,"1. BIOS",13,10,"2. XBOX CPU-KEY ",13,10,"3. Reiniciar",13,10,"4. Apagar",13,10,"                      ",13,10,13,10,"            Bootloader by Trung Hieu", 0
len equ $-menu
